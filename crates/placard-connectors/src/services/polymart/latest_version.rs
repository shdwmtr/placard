...
pub(crate) fn resolve_latest_version(
    ...
    let resource_id = params
        .get("resource-id")
        .ok_or("polymart-latest-version requires a data-resource-id attribute")?;
    ...
    let version = value
        ...
        .ok_or("polymart response missing response.resource.updates.latest.version")?;
    version
        .as_text()
...
mod tests {
    ...
    #[test]
    fn extracts_latest_version_from_a_polymart_shaped_response() {
