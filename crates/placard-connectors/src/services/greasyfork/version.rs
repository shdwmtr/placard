...
pub(crate) fn resolve_version(
    ...
    let script_id = params
        .get("script-id")
        .ok_or("greasyfork-version requires a data-script-id attribute")?;
    ...
    value
        ...
        .ok_or_else(|| "greasyfork response missing version".to_string())
}
...
mod tests {
    ...
    fn extracts_the_version() {
        let fetcher = FakeFetcher {
            ...
            body: r#"{"version": "1.4.2"}"#,
        };
        let value = resolve_version(&params("406540"), &fetcher).unwrap();
    ...
    fn falls_back_to_sleazyfork_when_greasyfork_fetch_fails() {
        ...
        let value = resolve_version(&params("406540"), &FallbackFetcher).unwrap();
    ...
    fn errors_when_the_field_is_missing() {
        ...
        assert!(resolve_version(&params("406540"), &fetcher).is_err());
    }
}
